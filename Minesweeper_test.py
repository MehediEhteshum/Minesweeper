...
try:
    # Required for displaying text, e.g. error, result.
    ...
    def display_error(error_message):
        ...
        msg = "Error: " + str(error_message) + \
            ". Minesweeper is not responding, exiting in 5 seconds..."
        # Setting font & font color.
        # font size adjustable with window size.
        fontSize = round(screenWidth*0.015)
        numFont = pygame.font.SysFont("Arial", fontSize, True)
        numColor = RED
        # Getting text surface and rectangle.
        textSurf, textRect = text_object(str(msg),
                                         numFont, numColor)
        # Drawing text.
    ...
    print("DISPLAY NOT FOUND. EXITING IN 5 SECONDS...")
